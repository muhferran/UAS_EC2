@extends('layout')
@section('content')
<div style="background: url('https://dmpiz6b8bulze.cloudfront.net/foto_frontend/wallpaper.jpeg') no-repeat center center fixed; background-size: cover; min-height: 100vh; width: 100vw; display: flex; align-items: center; justify-content: center;">
